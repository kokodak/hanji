...
| QA-013 | Table editing UX | Paste a Markdown table, edit cells, and copy the table. | Tables should stay in a stable editable table surface while preserving Markdown as the stored and copied format. Design: `docs/table-block-editor.md`. | Planned |
