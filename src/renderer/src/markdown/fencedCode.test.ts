...
export const tests = [
  ...
  },
  {
    ...
    run() {
      ...
      assert.equal(getFencedCodeLineDecoration(block, 1).spec.class, 'cm-live-codeblock cm-live-codeblock-first cm-live-codeblock-fence');
      assert.equal(getFencedCodeLineDecoration(block, 2).spec.class, 'cm-live-codeblock');
      assert.equal(getFencedCodeLineDecoration(block, 3).spec.class, 'cm-live-codeblock cm-live-codeblock-last cm-live-codeblock-fence');
    }
  },
  {
    ...
    run() {
      ...
      assert.equal(
        ...
        'cm-live-codeblock cm-live-codeblock-first cm-live-codeblock-fence'
      );
      ...
      assert.equal(
        ...
        'cm-live-codeblock cm-live-codeblock-last cm-live-codeblock-fence'
      );
    }
  },
  {
    ...
    run() {
      ...
      const fenceRule = getRuleBody('#editor .cm-line.cm-live-codeblock.cm-live-codeblock-fence');
      ...
      assert.match(fenceRule, /line-height:\s*1\.05;/);
